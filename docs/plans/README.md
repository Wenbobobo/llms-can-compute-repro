...
- `2026-04-07-post-p88-next-planmode-startup-prompt.md`
  preserved startup prompt for the post-`P88` no-import decision state
- `2026-04-07-post-p88-next-planmode-brief-prompt.md`
  preserved brief prompt for the post-`P88` no-import decision state
...
- `2026-04-07-post-p86-next-planmode-startup-prompt.md`
  preserved startup prompt for the post-`P86` inventory state
- `2026-04-07-post-p86-next-planmode-brief-prompt.md`
  preserved brief prompt for the post-`P86` inventory state
...
- `2026-04-07-post-p85-next-planmode-startup-prompt.md`
  preserved startup prompt from the post-`P85` merged-main rebaseline state
- `2026-04-07-post-p85-next-planmode-brief-prompt.md`
  preserved brief prompt from the post-`P85` merged-main rebaseline state
- `2026-04-07-post-p84-next-planmode-handoff.md`
  preserved shortest handoff from the post-`P84` promotion-ready closeout
  state
- `2026-04-07-post-p84-next-planmode-startup-prompt.md`
  preserved startup prompt from the post-`P84` promotion-ready closeout state
- `2026-04-07-post-p84-next-planmode-brief-prompt.md`
  preserved brief prompt from the post-`P84` promotion-ready closeout state
...
- `2026-04-03-post-p76-next-planmode-startup-prompt.md`
  preserved startup prompt from the prior `P74/P75/P76` publication state
- `2026-04-03-post-p76-next-planmode-brief-prompt.md`
  preserved brief prompt from the prior `P74/P75/P76` publication state
- `../../README.md`
...
- `../milestones/P79_post_p78_archive_claim_boundary_and_reopen_screen/`
  current claim-boundary wave
- `../milestones/P78_post_p77_legacy_worktree_convergence_and_quarantine_sync/`
  current convergence and quarantine sync wave
...
- landed operational follow-through foundation:
  `P56 -> P57 -> P58 -> P59`
- hygiene-only cleanup stack:
  `P69 -> P70 -> P71`
- archive polish and explicit stop handoff sidecar:
  `P72`
- local hygiene and shrink sidecar:
  `P73`
...
- `2026-03-26-post-h59-archive-and-reopen-screen-design.md`
  preserved design for the prior `H60/F34/P43/P44` wave
- `2026-03-25-post-h58-closeout-and-reopen-criteria-analysis.md`
  preserved closeout analysis for the completed value-negative lane
