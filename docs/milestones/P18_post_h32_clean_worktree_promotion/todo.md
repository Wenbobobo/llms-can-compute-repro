...
- [x] Save the post-`H30` / `H31` / `R38` / `H32` execution plan before edits.
- [x] Use one clean successor worktree rooted at `wip/p17-h30-clean`.
- [x] Define the narrowest reviewable packet split for the
  `H31/R38/H32` bundle and the current docs closeout sweep.
