...
Use this file as the top-level router for live control docs, preserved history,
and the dormant future dossier.

## Live Now

- `../README.md`
  restrained project landing page for the current `H65 + P89 + P88 + P87 + P86 + P85 + P84 + P83 + P77/P78/P79/P80 +
...
- `plans/README.md`
  preserved prior designs, handoffs, and startup prompts
- `milestones/README.md`
...
- `milestones/F38_post_h62_r63_dormant_eligibility_profile_dossier/`
  the only surviving future family, preserved as a dormant non-runtime
  eligibility dossier rather than a live scientific route
