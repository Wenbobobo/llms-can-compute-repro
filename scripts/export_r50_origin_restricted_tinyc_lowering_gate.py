"""Export the restricted tiny-C lowering gate for R50."""
...
OUT_DIR = ROOT / "results" / "R50_origin_restricted_tinyc_lowering_gate"
...
def assess_gate(exactness_rows: list[dict[str, object]], stop_rule: dict[str, object]) -> dict[str, object]:
    ...
    return {
        ...
        else "restricted_tinyc_lowering_break",
...
def build_artifacts() -> tuple[list[dict[str, object]], dict[str, object], dict[str, object]]:
    cases = r50_restricted_tinyc_lowering_cases()
    manifest_rows = [
        {
            "case_order": index + 1,
    ...
    stop_rule = {
        ...
        "stop_policy": "stop at first excluded tiny-C feature, canonical identity break, or exact free-running break",
    }
    report = {
    ...
    summary = {
        "summary": {
            ...
            "current_post_h48_planning_bundle": "f25_post_h48_restricted_tinyc_lowering_bundle",
            "active_runtime_lane": "r50_origin_restricted_tinyc_lowering_gate",
            "activation_bundle": "f25_post_h48_restricted_tinyc_lowering_bundle",
