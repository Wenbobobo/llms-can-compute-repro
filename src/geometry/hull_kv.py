...
class HullKVCache:
    ...
    def _rebuild_if_needed(self) -> None:
        ...
        for index, (key, value) in enumerate(self._entries):
            # ⚡ Bolt: Use explicit membership check to avoid eager dictionary instantiation
            # inside the hot loop. setdefault evaluates the default argument eagerly on every iteration.
