...
class HullKVCache:
    ...
    def _rebuild_if_needed(self) -> None:
        ...
        for index, (key, value) in enumerate(self._entries):
            # Performance optimization: Replace `dict.setdefault` with explicit
            # membership check to prevent eager evaluation and allocation of
            # `[Fraction(0) for _ in value]` on every iteration.
